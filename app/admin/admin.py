...
from .reader_csv_file import reader_csv, delete_all_files
...
class MyAdminIndexView(AdminIndexView):
    ...
    def Home(self):
        ...
        return self.render('admin/index.html', produtosc=produtos_crossdocking
        , cont_natualizado=cont_natualizado, produtoe=produtos_disponivel
        , cont_estoque=cont_estoque, atualizado_dia_marca=total_marcas, tot_nao_feito=naofeito)
    # pass
    # def is_accessible(self):
    #   return current_user.is_authenticated
    ...
    def upload_files(self):
        ...
        if filename != '':
            if '.csv' in filename:
                ...
                #Executa ao final e exclui os arquivos não utilizados
                delete_all_files()
...
class NotificationsView(BaseView):
    ...
    def disponivel_view(self, page):
        ...
        , filtro_marcas=marcas, estoque=estoques)
    ...
    def referencia_marcas(self):
        ...
        , marcas_produtos=marca, status=status_marca)
...
class Deparaview(ModelView):
    ...
    column_list = ['iddepara', 'IdProduto', 'ean', 'statusdepara',
                   'referenciafabricante', 'referenciahausz', 'nomeproduto'
                   , 'idmarcahausz', 'marca', 'bitativo']
    # column_default_sort = ('last_name', False)
    column_filters = [
...
class SellersPricesView(ModelView):
    ...
    can_view_details = True
    column_list = ['paginaprodutoseller','paginaprodutogoogle','skuhausz'
    , 'idprodutohausz', 'nomeproduto',
    'nomeseller','precoprodutoseller','metroseller','marcaprodutoseller'
    ,'precohausz','diferenciapreco','dataatualizado']
    # column_default_sort = ('last_name', False)
    column_filters = [
...
class IndesView(BaseView):
    ...
    def Home(self):
        ...
        return self.render('admin/index.html', produtosc=produtos_crossdocking
        , cont_natualizado=cont_natualizado, produtoe=produtos_disponivel
        , cont_estoque=cont_estoque, nao_tot=cont_dia_nao_atualizado)
